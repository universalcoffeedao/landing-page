        ...
        <Grid container spacing={2} className={styles.zapBond_content}>
          ...
          <Grid item md={6} sm={6} xs={12} className={styles.zapBond_left_side}>
            <Fade>
              ...
              >
                The founding team has renounced the ownership of the UCC
                contract. This means that there will be no UCC minted anymore,
                the UCC contract can’t be manipulated, and the protocol is fully
                decentralized.
              </Typography>
